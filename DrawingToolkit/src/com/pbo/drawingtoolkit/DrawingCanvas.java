        ...
        public void mousePressed(MouseEvent event) {
            switch (currentShapeType) {
                case 0:
                    ...
                    break;
                case 1:
                	currentShapeObject = new Oval(event.getX(), event.getY(), event.getX(), event.getY(), currentShapeColor, false);
                	break;
                case 2:
                	currentShapeObject = new Circle(event.getX(), event.getY(), event.getX(), event.getY(), currentShapeColor, false);
                	break;
                case 3:
                	currentShapeObject = new Rectangle(event.getX(), event.getY(), event.getX(), event.getY(), currentShapeColor, false);
                	break;
                case 4:
                	currentShapeObject = new Square(event.getX(), event.getY(), event.getX(), event.getY(), currentShapeColor, false);
                	break;
            }
        }
